...
Ce repository ```https://github.com/AdamChb/flash-green-front``` est celui de la première version du frontend. Hébergé sur *vercel.com* et codé avec Vue.js, il est la version classique du frontend de ce projet, sans optimisation de l'empreinte écologique de notre application.
